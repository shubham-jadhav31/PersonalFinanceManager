...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="./income.php" id="nav_currentpage">Income <span class="sr-only"></span></a>
      </li>
      <li class="nav-item active">
...
<div class="db">
  ...
  $conn = mysqli_connect($servername, $username, $password, $database);
   ...
   $sql = "SELECT * FROM transactions where type='Income' && `id`=$user_id";
...
<table class="table table-bordered"> 
	<tr> 
		<th colspan="6" class="text-center"><h2>Income Record</h2></th> 
		</tr> 
