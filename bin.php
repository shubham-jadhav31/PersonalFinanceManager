...
<!-- ============================================Nav Bar=========================================================================================== -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="./bin.php" id="nav_currentpage">Bin <span class="sr-only">(current)</span></a>
      </li>
    </ul>
...
<div class="db1">
  ...
  $conn = mysqli_connect($servername, $username, $password, $database);
   ...
   $sql = "SELECT `transaction_id`, `amount`, `type`, `category`, `date`, `time` FROM transactions_bin WHERE `id`=$user_id";
...
<table class="table table-bordered"> 
	<tr> 
		<th colspan="6" class="text-center"><h2>Transaction Bin</h2></th> 
		</tr> 
...
<div class="db2">
  ...
  $conn = mysqli_connect($servername, $username, $password, $database);
   ...
   $sql = "SELECT `dept_id`, `amount`, `creditor`, `interest_rate`, `due_date`, `date`, `time` FROM debts_bin WHERE `id`=$user_id";
   $result = mysqli_query($conn, $sql);
...
<table class="table table-bordered"> 
	<tr> 
		<th colspan="7" class="text-center"><h2>Debt Bin</h2></th> 
		</tr> 
    <tr class="sticky-header bg-dark text-light">
        <th> Dept id </th> 
        <th> Amount </th> 
...
<div class="db3">
  ...
  $conn = mysqli_connect($servername, $username, $password, $database);
   ...
   $sql = "SELECT `budget_id`, `amount`, `category`, `start_date`, `end_date`, `date`, `time` FROM budgets_bin WHERE `id`=$user_id";
   $result = mysqli_query($conn, $sql);
...
<table class="table table-bordered"> 
	<tr> 
		<th colspan="7" class="text-center"><h2>Budget Bin</h2></th> 
		</tr> 
  <tr class="sticky-header bg-dark text-light">
			  <th> Budget_id </th> 
			  <th> Amount </th>  
...
<div class="db4">
  ...
  $conn = mysqli_connect($servername, $username, $password, $database);
   ...
   $sql = "SELECT * FROM investment_bin WHERE `id`=$user_id";
   $result = mysqli_query($conn, $sql);
...
<table class="table table-bordered"> 
	<tr> 
		<th colspan="6" class="text-center"><h2>Investment Bin</h2></th> 
		</tr> 
    <tr class="sticky-header bg-dark text-light">
		<th> Investment_id </th> 
		<th> Amount </th>
